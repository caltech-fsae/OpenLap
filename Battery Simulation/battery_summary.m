if(battery.SOC(end) ~= 0)
    disp(strcat("Final Battery State: ",num2str(100*battery.SOC(end)),"% Charge Remaining"));
    ...
    completion = find((battery.SOC == 0),1)/size(battery.SOC,1);
    disp(strcat("Battery died ", num2str(completion*100), "% through the race"));
end